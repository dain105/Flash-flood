...
date<-cbind(date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date,date)
...
sws<-sws.mtx[2209:11040,]
date<-date[2209:11040,]
date<-as.matrix(date)
##########################################################################################
#4year 강우량 데이터 생성
#6개씩 나눔
...
#엑셀로 데이터 저장
#write.csv(sws.dataset,"E:/flash/data/sws.csv")
...
#write.csv(date.dataset,"date.csv")
##########################################################################################
##########################################################################################
#merge data
##########################################################################################
